...
def main() -> int:
    ...
    # TODO 2: Stampa i 4 elementi richiesti
    print("\n--- RISULTATI ---")
    print("1. Risposta:", reply.choices[0].message.content)
    print("2. Motivo di fine (Finish reason):", reply.choices[0].finish_reason)
    print("3. Token (Prompt / Generati):", reply.usage.prompt_tokens, "/", reply.usage.completion_tokens)
    print("4. Tempo trascorso:", elapsed, "secondi\n")
    ...
    # TODO 3: Chiudi la registrazione
    rec.finish(
